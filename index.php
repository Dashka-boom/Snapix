                                        ...
                                        <div class="feed-card-buttons">
                                            <div class="feed-action-item">
                                                <form method="post" class="inline-action-form">
                                                    ...
                                                    <button type="submit" class="feed-action-btn feed-icon-btn<?php echo (int) $post['is_liked'] > 0 ? ' is-active' : ''; ?>" aria-label="Лайк"></button>
                                                </form>
                                            ...
                                            <div class="feed-action-item">
                                                <form method="post" class="inline-action-form">
                                                    ...
                                                    <input type="hidden" name="post_id" value="<?php echo (int) $post['id']; ?>">
                                                    <button type="submit" class="feed-action-btn feed-icon-btn feed-action-btn-save<?php echo (int) $post['is_saved'] > 0 ? ' is-saved' : ''; ?>" aria-label="Избранное"></button>
                                                </form>
                                            ...
                                            <div class="feed-action-item">
                                                <form method="post" class="inline-action-form">
                                                    ...
                                                    <input type="hidden" name="post_id" value="<?php echo (int) $post['id']; ?>">
                                                    <button type="submit" class="feed-action-btn feed-icon-btn feed-action-btn-repost<?php echo (int) $post['is_reposted'] > 0 ? ' is-reposted' : ''; ?>" aria-label="Репост"></button>
                                                </form>
                                                <span class="feed-action-count"><?php echo (int) $post['reposts_count']; ?></span>
                                            </div>

                                            <div class="feed-action-item">
                                                <button type="button" class="feed-action-btn feed-icon-btn js-open-share-modal" data-post-id="<?php echo (int) $post['id']; ?>" aria-label="Отправить в сообщения"></button>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="feed-card-buttons">
